      ...
      <div>
        <div>
          ...
          <Collapse isOpen={this.state.collapse}>
            {pendingCollaborators && (pendingCollaborators.length ? pendingCollaborators.map((collaborator, index) => <PendingCollaborators key={index} pendingCollaborators={collaborator} accept={this.props.accept} reject = {this.props.reject}/>) : <p>No collaborators pending</p>)}
          </Collapse>
        </div>
      </div>
    );
